...
Developed and delivered primarily by PhD students from the **SENSE CDT** (Centre for Satellite Data in Environmental Science), our goal is to inspire the next generation of scientists by showing them how we use satellites to monitor our changing planet.
